...
const float CMD_VEL = 0.0f;             // Normalized [-1, 1] velocity command (+ forward, - back)
const float CMD_YAW = 1.0f;             // Normalized [-1, 1] yaw command (+ left, - right)
const float VEL_FACTOR = 0.6f;          // Max velocity that was used in training
const float YAW_FACTOR = 1.0f;          // Max yaw that was used in training
